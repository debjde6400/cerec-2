...
class avl_tree(object):
            ...
            if node is None:
                ...
                if (node.leftchild==None) and (node.rightchild==None):
                    ...
                    del node
                     ...
                     replace_node=self.minimum(node.rightchild)
    ...
    def search_return_node(self, rst, x):
        if rst==None:
            return
        if rst.data == x:
            return rst
        elif rst.leftchild == None and rst.rightchild == None:
            return None
        elif rst.data < x:
            return self.search_return_node(rst.rightchild, x)
        else:
            return self.search_return_node(rst.leftchild, x)
    ...
    def successor(self, x):
        node = self.search_return_node(self.root, x)
        if node.rightchild:
            return self.minimum(node.rightchild)
        y = node.parent
        while y and node == y.rightchild:
            node = y
            y = y.parent
        return y
