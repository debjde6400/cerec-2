...
print(myavl.minimum(myavl.root).data)
...
print(myavl.search_return_node(myavl.root, 18))
print(myavl.predecessor(myavl.search_return_node(myavl.root, 18)).data)
print(myavl.successor(myavl.search_return_node(myavl.root, 18)).data)